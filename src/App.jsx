    ...
    (async () => {
      try {
        ...
        for (const rec of DATA.records) {
          ...
          if (u) rec.url = u;
          /* The live-sync path carried the same too-loose gate the bundled
        ...
        DATA.meta.structural_candidate_count = DATA.records.filter((r) => r.structural_candidate).length;
